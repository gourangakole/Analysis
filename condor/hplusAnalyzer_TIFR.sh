...
cp -r /home/gkole/Analysis/ChargedHiggs/13TeV/mu_channel/CMSSW_8_0_28 .
#cp -r /home/$USER/t3store2/CMSSW_8_0_28/ .

#------------------------------------------------
#copy the lxplus package to the remote machine
#and run the codes at remote machine
#------------------------------------------------
cd CMSSW_8_0_28/src/Analysis/
...
#------------------------------------------------
echo "OUTPUT: "
ls ${_CONDOR_SCRATCH_DIR}/CMSSW_8_0_28/src/Analysis/13TeV/$outAnalDir

cp -rf ${_CONDOR_SCRATCH_DIR}/CMSSW_8_0_28/src/Analysis/13TeV/$outAnalDir/* /home/$USER/condor_out/histo_ttbar_14Aug2017_v1
