...
void hplusAnalyzer::CutFlowProcessor(TString url,  string myKey, TString cutflowType, TFile *outFile_){
  ...
  TTree *t_KinFit = new TTree("KinFit_tree","My test tree");
  ...
  for(int i=0; i<nEntries; ++i){
    ...
    fillHisto(outFile_, cutflowType+"/Iso", "","pt_met", 100, 0, 1000, metPt, evtWeight );
    //    fillHisto2D(outFile_, cutflowType+"/Iso", "", 100, 0, 1000, metPt, "RelIso_MET", 50, 0, 1, tmp_iso,evtWeight );
    ...
    muonPt = muPtWithRochCorr(&pfMuons[m_i], ev->isData, u1, u2, 0, 0);
    ...
    */
    ...
    //t.Branch('muonPt',muonPt , 'muonPt/D')
    Weight = evtWeight;
    //t_BTag->Fill();
    ...
    // temporary check for bjet index matching
    int indexForBTag = 0;
    bool match_j3 = false;
    for(size_t ij = 0; ij < j_final.size(); ij++){
      int ind_ij = j_final[ij];
      if(DeltaR(kfBjet[0], pfJets[ind_ij].p4) < 0.2){
        match_j3=true;
        indexForBTag = ind_ij;
      }
    }

    int indexForLepBTag = 0;
    bool match_j4 = false;
    for(size_t ij = 0; ij < j_final.size(); ij++){
      int ind_ij = j_final[ij];
      if(DeltaR(kfJetsLepB[0], pfJets[ind_ij].p4) < 0.2){
        match_j4=true;
        indexForLepBTag = ind_ij;
      }
    }
...
void hplusAnalyzer::processEvents(){ 
  ...
  //  CutFlowAnalysis("root://se01.indiacms.res.in:1094//cms/store/user/rverma/ntuple_MuMC_kfitM_20180425/MuMC_20180425/HplusM120_MuMC_20180425/ChargedHiggsToCS_M120_13TeV-madgraph/HplusM120_MuMC_20180425/180425_100527/0000/HplusM120_MuMC_20180425_Ntuple_12.root", "PF", "");
  //CutFlowAnalysis("root://se01.indiacms.res.in:1094//cms/store/user/rverma/ntuple_MuData_kfitM_20180421/MuData_20180421/MuRunB2v2_MuData_20180421/SingleMuon/MuRunB2v2_MuData_20180421/180421_151510/0000/MuRunB2v2_MuData_20180421_Ntuple_10.root", "PF", "");
  //====================================
  //condor submission
